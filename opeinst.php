...
<head>
    ...
    <title>Operations Einsteiger</title>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="container-fluid mb">
        <div class="row">
            ...
            <!--<div class="col-md-8">-->
            <div class="col-lg-8">
                <img src="images/operations_einsteiger-innen_1704x717.jpg" class="img-fluid" alt="...">
            </div>
            ...
            <div class="col-lg-4 ">
                <div class="card border-primary mb-3">
                    ...
                    <div class="card-body text-primary">
                        ...
                        <p class="card-text"><?= $lang['zielgruppe_t'] ?></p>
                            ...
                            <div class="modal-dialog text-dark">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="staticBackdropLabel"><?= $lang['buchen_op_e'] ?></h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form class="row g-3" method="POST" action="buche_opeinst.php">
                                            <div class="col-md-4">
    ...
    <div class="container-fluid">
        <p class="fs-2"><strong><?= $lang['kluge'] ?></strong></p>
    ...
    <blockquote class="blockquote">
        <ul class="list-unstyled">
            <ul>
                <li><?= $lang['erwartung_t1'] ?></li>
                <li><?= $lang['erwartung_t2'] ?></li>
                <li><?= $lang['erwartung_t3'] ?></li>
                <li><?= $lang['erwartung_t4'] ?></li>
            </ul>
        </ul>
    </blockquote>
    <div class="container-fluid">
